...
<html lang="en">
  ...
  <body>
    ...
    <div class='pt-3'>
      <h1 class='text-center pb-4'>Vote For Student Council Mess Secretary</h1>
    </div>
    ";
        include 'dbcon.php';
      if($_SESSION['flag_ms']==0){

        $candidateselect = "select * from candidates where position = 'Mess Secretary' ";
        ...
        while($j<=$i){
            ...
            if( isset($_POST['details' . $j]) ){
                  ...
                  ?>
                        <script>location.replace('voting_cs.php')</script>
                  <?php
            }
            $j++;
        }
