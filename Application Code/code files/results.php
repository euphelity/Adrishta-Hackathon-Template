...
<html lang="en">
  ...
  <body>
    ...
    if($election['status']=="Disabled"){
        ...
        $candidateselect = "select * from candidates where position = 'president' order by votes desc";
        ...
        $candidateselect = "select * from candidates where position = 'Vice President' order by votes desc";
        $candidatequery = mysqli_query($con, $candidateselect);
        $i=1;
        echo "<form method='POST'>";
        while($candidate = mysqli_fetch_assoc($candidatequery)){
        ...
        $candidateselect = "select * from candidates where position = 'Mess Secretary' order by votes desc";
        $candidatequery = mysqli_query($con, $candidateselect);
        $i=1;
        echo "<form method='POST'>";
        while($candidate = mysqli_fetch_assoc($candidatequery)){
        ...
        $candidateselect = "select * from candidates where position = 'Cultural Secretary' order by votes desc";
        $candidatequery = mysqli_query($con, $candidateselect);
        $i=1;
        echo "<form method='POST'>";
        while($candidate = mysqli_fetch_assoc($candidatequery)){
        ...
        $candidateselect = "select * from candidates where position = 'Sports Secretary' order by votes desc";
        $candidatequery = mysqli_query($con, $candidateselect);
        $i=1;
        echo "<form method='POST'>";
        while($candidate = mysqli_fetch_assoc($candidatequery)){
        ...
        $candidateselect = "select * from candidates where position = 'General Secretary' order by votes desc";
        $candidatequery = mysqli_query($con, $candidateselect);
        $i=1;
        echo "<form method='POST'>";
        while($candidate = mysqli_fetch_assoc($candidatequery)){
        ...
        ?>
                    <script>
                        alert("Results are not available now!");
