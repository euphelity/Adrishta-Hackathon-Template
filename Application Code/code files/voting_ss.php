...
<html lang="en">
  ...
  <body>
    ...
    <div class='pt-3'>
      <h1 class='text-center pb-4'>Vote For Student Council Sports Secretary</h1>
    </div>
    ";
        include 'dbcon.php';
      if($_SESSION['flag_ss']==0){
        $candidateselect = "select * from candidates where position = 'Sports Secretary' ";
        ...
        while($j<=$i){
            ...
            if( isset($_POST['details' . $j]) ){
                  ...
                  ?>
                        <script>location.replace('voting_gs.php')</script>
                  <?php
            }
            $j++;
        }
