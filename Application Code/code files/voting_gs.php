...
<html lang="en">
  ...
  <body>
    ...
    <div class='pt-3'>
      <h1 class='text-center pb-4'>Vote For Student Council General Secretary</h1>
    </div>
    ";
        include 'dbcon.php';
      if($_SESSION['flag_gs']==0){
        $candidateselect = "select * from candidates where position = 'General Secretary' ";
        ...
        while($j<=$i){
            ...
            if( isset($_POST['details' . $j]) ){
                  ...
                  $userselect = " update voters set ifvoted = 1 where id = '$id' ";
