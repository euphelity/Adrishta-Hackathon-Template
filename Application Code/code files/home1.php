...
<html lang="en">
  ...
  <body>
        ...
        <div class="country-banner">
          <div class="country-flag">
            ...
            <div class="button sec-1-btn h5">
              <span class="content"
                ><a style="text-decoration: none; color: black" href="login.php"
                  >Vote for Council</a
                ></span
              >
            ...
            <button class="button sec-1-btn h5">
              <a style="text-decoration: none; color: black" href="results.php">
                View Results
              </a>
            </button>
          </div>
    ...
    <div style="height: 89vh; position: relative; top: 400px">
      <hr />
      <div class="details">
        <div>
        ...
        <ol>
          <li>
            1. The voting for council election will take place on 1st
            December,2020
          </li>
          <li>
          ...
          <li>
            3. Resgister yourself as a voter , login and then vote your
            favoutite candidate .
          </li>
          <li>
